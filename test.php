...
<section class="content">
  ...
  <h3>All Vacancies</h3>
  <div class="filter">Filter By status :
    <a href="test.php"><span class="label label-default">All</span></a>
 ...
 <div class="panel panel-<?php print $label;?>">
  <div class="panel panel-header">
     <div class="pull-left">
      ...
      <?php print '<b>' .$i.'. '.$row['title'] . '</b> - ' .date("d M Y H:i", strtotime($row['created_date'])); ?>  </div>
        <div class="pull-right"><span class="badge">By : <?php print $name['name'];?></span> | <a href="view.php?vid=<?php print $row['id']; ?>"><span class="badge">Action</span></a></div>        
      </div>
  </div>
